...
use DB;
	...
	class Madmin extends \Eloquent{
		...
		public static function getUser($username){
			$result = Madmin::select('username', 'password')->where('username', '=', $username)->get();
		...
		public static function getCountUser($where){
			$result = Madmin::where($where)->count();
			return $result;
		}

		public static function getPass($pass){
			$result = Madmin::where('password', '=', $pass)->count();
			return $result;
		}
